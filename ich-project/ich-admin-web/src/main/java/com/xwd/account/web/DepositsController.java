...
@Controller
@Scope("prototype")
@RequestMapping("/admin/account/deposits")
public class DepositsController extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page<Deposits> page = depositsService.findByPageRequest(pageRequest);
	...
	public 	void delete(HttpServletRequest request, HttpServletResponse response)throws Exception {
		String ids = get("ids");
		depositsService.deleteByIds(ids);
	}
