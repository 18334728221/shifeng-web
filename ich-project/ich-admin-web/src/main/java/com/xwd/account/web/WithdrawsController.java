...
@Controller
@Scope("prototype")
@RequestMapping("/admin/base/withdraws")
public class WithdrawsController extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page<Withdraws> page = withdrawsService.findByPageRequest(pageRequest);
	...
	public 	void save(HttpServletRequest request, HttpServletResponse response)throws Exception {
		...
		if(id == null){
			entity = new Withdraws();
			this.setFieldValues(entity, request, false);
		}else{
			entity = withdrawsService.get(id);
			if(entity == null){
