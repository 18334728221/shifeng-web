...
@Controller
@Scope("prototype")
@RequestMapping("/admin/image/server")
public class ImageServerController extends BaseAdminController {
	...
	public void findAll(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page page = imageServerService.findByPageRequest(pageRequest);
	...
	public 	void save(HttpServletRequest request, HttpServletResponse response)throws Exception {
		...
		imageServerService.saveOrUpdate(entity);
	...
	public void delete(HttpServletRequest request, HttpServletResponse response)throws Exception {
		String ids = get("ids");
		imageServerService.deleteByIds(ids);
		logService.add(request, "");
	}
