...
import com.xwd.customer.service.FriendService;

@Controller
@Scope("prototype")
@RequestMapping("/admin/customer/friend")
public class FriendController extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page<Friend> page = friendService.findByPageRequest(pageRequest);
	...
	public 	void save(HttpServletRequest request, HttpServletResponse response)throws Exception {
		...
		friendService.saveOrUpdate(entity);
