...
@Controller
@Scope("prototype")
@RequestMapping("/admin/evaluate/evaluate")
public class EvaluateController extends BaseAdminController {
	...
	public String index() {
		return "/admin/evaluate/evaluate";
	}
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page<Evaluate> page = evaluateService.findByPageRequest(pageRequest);
		logService.add(request, "查询评价");
	...
	public 	void save(HttpServletRequest request, HttpServletResponse response)throws Exception {
		...
		if(id == null){
			...
			logService.add(request, "修改评价");
			this.setFieldValues(entity, request, true);
		}
		evaluateService.saveOrUpdate(entity);
	...
	public 	void delete(HttpServletRequest request, HttpServletResponse response)throws Exception {
		String ids = get("ids");
		evaluateService.deleteByIds(ids);
		logService.add(request, "删除评价");
		this.outSuccessJson(response);
	}
