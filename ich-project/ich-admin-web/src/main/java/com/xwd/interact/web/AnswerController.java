...
import com.xwd.interact.service.AnswerService;

@Controller
@Scope("prototype")
@RequestMapping("/admin/base/answer")
public class AnswerController extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page<Answer> page = answerService.findByPageRequest(pageRequest);
