...
@Controller
@Scope("prototype")
@RequestMapping("/admin/base/emailCustomer")
public class EmailCustomerController extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page<EmailCustomer> page = emailCustomerService.findByPageRequest(pageRequest);
	...
	public 	void save(HttpServletRequest request, HttpServletResponse response)throws Exception {
		...
		EmailCustomer  entity;
		Long id = this.getLong("id");
		if(id == null){
			entity = new EmailCustomer();
			this.setFieldValues(entity, request, false);
		}else{
			entity = emailCustomerService.get(id);
			if(entity == null){
		...
		emailCustomerService.saveOrUpdate(entity);
	...
	public 	void delete(HttpServletRequest request, HttpServletResponse response)throws Exception {
		String ids = get("ids");
		emailCustomerService.deleteByIds(ids);
	}
