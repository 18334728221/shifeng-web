...
@Controller
@Scope("prototype")
@RequestMapping("/admin/base/emailUser")
public class EmailUserController extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page<EmailUser> page = emailUserService.findByPageRequest(pageRequest);
