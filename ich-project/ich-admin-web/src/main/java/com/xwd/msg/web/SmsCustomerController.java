...
@Controller
@Scope("prototype")
@RequestMapping("/admin/base/smsCustomer")
public class SmsCustomerController extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page<SmsCustomer> page = smsCustomerService.findByPageRequest(pageRequest);
	...
	public 	void save(HttpServletRequest request, HttpServletResponse response)throws Exception {
		...
		if(id == null){
			entity = new SmsCustomer();
			this.setFieldValues(entity, request, false);
		}else{
			entity = smsCustomerService.get(id);
			if(entity == null){
		...
		smsCustomerService.saveOrUpdate(entity);
	...
	public 	void delete(HttpServletRequest request, HttpServletResponse response)throws Exception {
		String ids = get("ids");
		smsCustomerService.deleteByIds(ids);
	}
