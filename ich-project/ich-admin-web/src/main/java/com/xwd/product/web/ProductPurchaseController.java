...
@Controller
@Scope("prototype")
@RequestMapping("/admin/product/productPurchase")
public class ProductPurchaseController extends BaseAdminController {
	...
	public String index() {
		return "/admin/product/productPurchase";
	}
	...
	public 	void save(HttpServletRequest request, HttpServletResponse response)throws Exception {
		...
		productPurchaseService.saveOrUpdate(entity);
	...
	public 	void delete(HttpServletRequest request, HttpServletResponse response)throws Exception {
		String ids = get("ids");
		productPurchaseService.deleteByIds(ids);
	}
