...
@Controller
@Scope("prototype")
@RequestMapping("/admin/base/poundage")
public class PoundageController extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page<Poundage> page = poundageService.findByPageRequest(pageRequest);
	...
	public 	void save(HttpServletRequest request, HttpServletResponse response)throws Exception {
		...
		poundageService.saveOrUpdate(entity);
	...
	public 	void delete(HttpServletRequest request, HttpServletResponse response)throws Exception {
		String ids = get("ids");
		poundageService.deleteByIds(ids);
	}
