...
@Controller
@Scope("prototype")
@RequestMapping("/admin/base/weekLine")
public class WeekLineController extends BaseAdminController {
	
	@Autowired
	private WeekLineService weekLineService;
	
	@RequestMapping("/index")
	public String index() {
		return "/admin/base/weekLine";
	}
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page<WeekLine> page = weekLineService.findByPageRequest(pageRequest);
	...
	public 	void save(HttpServletRequest request, HttpServletResponse response)throws Exception {
		...
		weekLineService.saveOrUpdate(entity);
	...
	public 	void delete(HttpServletRequest request, HttpServletResponse response)throws Exception {
		String ids = get("ids");
		weekLineService.deleteByIds(ids);
	}
