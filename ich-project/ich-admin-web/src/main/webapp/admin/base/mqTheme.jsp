...
<body>
			...
			<div style="overflow:hidden;">
				...
				<div style="float:right;padding:5px 0;">
					<form action="" id="f_search" style="display:inline-block;">
						<input name="topic" type="text" class="form-control input-sm dis-i-b w-auto" placeholder="主题名称" />
						<input name="tags" type="text" class="form-control input-sm dis-i-b w-auto" placeholder="标记" />
					</form>
		...
		<form action="" class="e-form" method="post">
			<ul class="e-table" border="0">
				<li>
					...
					<p>主题名称:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="topic" param-index="1" />
				</li>
				<li>
					<p>标记:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="tags" param-index="2" />
				</li>
			</ul>
		</form>
	...
	<script type="text/javascript">
		homePath = "${ctx}";
		findUrl = homePath + "/admin/base/mq/theme/findAll";
		saveUrl = homePath + "/admin/base/mq/theme/save";
		deleteUrl = homePath + "/admin/base/mq/theme/delete";
		entityName = "消息中间件主题";
		columns = [
			{ data: "id" },
			{ data: "topic" },
		...
		$(function(){
			$("#theme_index").css("background-color","#ffffff");
			$("#content2").show();
		});
	</script>
</body>
