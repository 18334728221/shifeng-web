...
<body>
			...
			<div style="overflow:hidden;">
				...
				<div style="float:right;padding:5px 0;">
					<form action="" id="f_search" style="display:inline-block;">
						<input name="account" type="text" class="form-control input-sm dis-i-b w-auto" placeholder="接口帐号" />
						<input name="cgid" type="text" class="form-control input-sm dis-i-b w-auto" placeholder="通道组编号" />
					</form>
		...
		<form action="" class="e-form" method="post">
			<ul class="e-table" border="0">
				<li>
					...
					<p>接口帐号:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="account" param-index="0" />
				</li>
				<li>
					<input type="hidden" name="id" param-index="0" />
					<p>接口密钥:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="authkey" param-index="1" />
				</li>
				<li>
					<p>通道组编号:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="cgid" param-index="2" />
				</li>
				<li>
					<p>默认使用的签名编号:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="csid" param-index="3" />
				</li>
			</ul>
		</form>
	...
	<script type="text/javascript">
		homePath = "${ctx}";
		findUrl = homePath + "/admin/base/sms/server/findAll";
		saveUrl = homePath + "/admin/base/sms/server/save";
		deleteUrl = homePath + "/admin/base/sms/server/delete";
		entityName = "短信";
		columns = [
			{ data: "id" },
			{ data: "account" },
		...
		$(function(){
			$("#sms_server_index").css("background-color","#ffffff");
			$("#content2").show();
		});
	</script>
</body>
