...
<body>
			...
			<div style="overflow:hidden;">
				...
				<div style="float:right;padding:5px 0;">
					<form action="" id="f_search" style="display:inline-block;">
						...
						<input name="areaName" type="text" class="form-control input-sm dis-i-b w-auto" placeholder="地区名称" />
						<input name="target" type="text" class="form-control input-sm dis-i-b w-auto" placeholder="地区编号" />
						<input name="parentId" type="text" class="form-control input-sm dis-i-b w-auto" placeholder="所属地区" />
					</form>
		...
		<form action="" class="e-form" method="post">
			<ul class="e-table" border="0">
				<li>
					...
					<p>地区名称:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="areaName" param-index="1" />
				</li>
				<li>
					<p>地区编号:&nbsp;</p>
				...
				<li>
					<p>所属地区:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="parentId" param-index="3" />
				</li>
			</ul>
		</form>
	...
	<script type="text/javascript">
		homePath = "${ctx}";
		findUrl = homePath + "/admin/dd/area/findAll";
		saveUrl = homePath + "/admin/dd/area/save";
		deleteUrl = homePath + "/admin/dd/area/delete";
		entityName = "地区";
		columns = [
			{ data: "id" },
			{ data: "areaName" },
		...
		$(function(){
			$("#area_index").css("background-color","#ffffff");
			$("#content3").show();
			var setting = {
				view: {
			...
			$.getJSON(homePath+"/admin/dd/area/findAllTree","",function(result){
