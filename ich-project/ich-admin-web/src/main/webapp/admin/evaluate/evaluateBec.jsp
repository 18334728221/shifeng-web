...
<body>
	...
	<div id="edit_box" style="display:none;">
		<form action="" class="e-form" method="post">
			<ul class="e-table" border="0">
				...
				<li>
					<p>评价内容ID:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="becId" param-index="2" />
				</li>
				<li>
					<p>星级:&nbsp;</p>
	...
	<script type="text/javascript">
		homePath = "${ctx}";
		findUrl = homePath + "/admin/evaluate/evaluateBec/find";
		saveUrl = homePath + "/admin/evaluate/evaluateBec/save";
		deleteUrl = homePath + "/admin/evaluate/evaluateBec/delete";
		entityName = "评价内容";
		columns = [
			{ data: "id" },
			{ data: "customerNo" },
		...
		$(function(){
			$("#evaluateBec_index").css("background-color","#ffffff");
			$("#content6").show();
		});
	</script>
</body>
