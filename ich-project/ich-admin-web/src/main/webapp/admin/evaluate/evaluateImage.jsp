...
<body>
		...
		<form action="" class="e-form" method="post">
			<ul class="e-table" border="0">
				<li>
					...
					<p>评价编号:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="evaluateId" param-index="1" />
				</li>
				<li>
					<p>图片ID:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="imageId" param-index="2" />
				</li>
				<li>
					<p>图片服务器ID:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="imageServerId" param-index="3" />
				</li>
	...
	<script type="text/javascript">
		homePath = "${ctx}";
		findUrl = homePath + "/admin/evaluate/evaluateImage/find";
		saveUrl = homePath + "/admin/evaluate/evaluateImage/save";
		deleteUrl = homePath + "/admin/evaluate/evaluateImage/delete";
		entityName = "评价图片";
		columns = [
			{ data: "id" },
			{ data: "evaluateId" },
		...
		$(function(){
			$("#evaluateImage_index").css("background-color","#ffffff");
			$("#content6").show();
		});
	</script>
</body>
