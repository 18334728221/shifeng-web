...
<body>
	...
	<div id="edit_box" style="display:none;">
		<form action="" class="e-form" method="post">
			<ul class="e-table" border="0">
				...
				<li>
					<p>产品评价内容ID:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="pecId" param-index="2" />
				</li>
	...
	<script type="text/javascript">
		homePath = "${ctx}";
		findUrl = homePath + "/admin/evaluate/evaluatePec/find";
		saveUrl = homePath + "/admin/evaluate/evaluatePec/save";
		deleteUrl = homePath + "/admin/evaluate/evaluatePec/delete";
		entityName = "评价图片";
		columns = [
			{ data: "id" },
			{ data: "customerNo" },
		...
		$(function(){
			$("#evaluatePec_index").css("background-color","#ffffff");
			$("#content6").show();
		});
	</script>
</body>
