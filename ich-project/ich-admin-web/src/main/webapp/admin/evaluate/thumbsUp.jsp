...
<body>
	...
	<div id="edit_box" style="display:none;">
		<form action="" class="e-form" method="post">
			<ul class="e-table" border="0">
				...
				<li>
					<p>用户编号:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="userId" param-index="2" />
				</li>
				<li>
					<p>顾客编号:&nbsp;</p>
	...
	<script type="text/javascript">
		homePath = "${ctx}";
		findUrl = homePath + "/admin/evaluate/thumbsUp/find";
		saveUrl = homePath + "/admin/evaluate/thumbsUp/save";
		deleteUrl = homePath + "/admin/evaluate/thumbsUp/delete";
		entityName = "评价图片";
		columns = [
			{ data: "id" },
			{ data: "evaluateId" },
		...
		$(function(){
			$("#thumbsUp_index").css("background-color","#ffffff");
			$("#content6").show();
		});
	</script>
</body>
