...
<body>
	...
	<script type="text/javascript">
		homePath = "${ctx}";
		findUrl = homePath + "/admin/base/logBuyerCommission/find";
		saveUrl = homePath + "/admin/base/logBuyerCommission/save";
		deleteUrl = homePath + "/admin/base/logBuyerCommission/delete";
		entityName = "日志管理";
		columns = [
			{ data: "customerNo"},
			{ data: "productName"},
