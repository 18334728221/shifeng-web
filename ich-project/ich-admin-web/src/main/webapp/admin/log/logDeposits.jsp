...
<body>
	...
	<script type="text/javascript">
		homePath = "${ctx}";
		findUrl = homePath + "/admin/base/logDeposits/find";
		saveUrl = homePath + "/admin/base/logDeposits/save";
		deleteUrl = homePath + "/admin/base/logDeposits/delete";
		entityName = "logDeposits";
		columns = [
			{ data: "customerNo"},
			{ data: "txNo"},
			{ data: "userId"},
		...
		$(function(){
			$("#logDeposits_index").css("background-color","#ffffff");
			$("#content7").show();
		});
	</script>
</body>
