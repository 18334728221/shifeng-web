...
<body>
			...
			<div style="overflow:hidden;">
				...
				<div style="float:right;padding:5px 0;">
					<form action="" id="f_search" style="display:inline-block;">
						<input name="userName" type="text" class="form-control input-sm dis-i-b w-auto" placeholder="用户名称" />
	...
	<script type="text/javascript">
		homePath = "${ctx}";
		findUrl = homePath + "/admin/base/logUser/find";
		saveUrl = homePath + "/admin/base/logUser/save";
		deleteUrl = homePath + "/admin/base/logUser/delete";
		entityName = "日志管理";
		columns = [
			{ data: "userId"},
			{ data: "userName"},
		...
		$(function(){
			$("#LogUser_index").css("background-color","#ffffff");
			$("#content8").show();
		});
	</script>
</body>
