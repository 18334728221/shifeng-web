...
<body>
	...
	<script type="text/javascript">                                	
		homePath = "${ctx}";                                       	
		findUrl = homePath + "/admin/product/cancelOrder/find";          	
		saveUrl = homePath + "/admin/product/cancelOrder/save";          	
		deleteUrl = homePath + "/admin/product/cancelOrder/delete";      	
		entityName = "交易撤销记录";                               	
		columns = [                                                	
			{ data: "id" },                 
			{ data: "customerNo" },        
			{ data: "productName" },        
			{ data: "entrustTimeString" },  
			{ data: "tradeMarkString" },    
			{ data: "entrustPrice" },       
			{ data: "entrustNumber" },      
			{ data: "turnoverQuantity" } ,   
			{ data: "priceMethodString" } ,        
			{ data: "tradeStatusString" }         
		];
