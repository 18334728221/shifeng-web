...
<body>
	...
	<div id="edit_box" style="display:none;">
		<form action="" class="e-form" method="post">
			<ul class="e-table" border="0">
				...
				<li>
					<p>股票数量:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="sharesNumber" param-index="3" />
				</li>
				<li>
					<p>价格:&nbsp;</p>
				...
				<li>
					<p>购买时间:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="buyTime" param-index="5" />
				</li>
				<li>
					<p>可卖时间:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="sellTime" param-index="6" />
				</li>
	...
	<script type="text/javascript">
		homePath = "${ctx}";
		findUrl = homePath + "/admin/product/customer/find";
		saveUrl = homePath + "/admin/product/customer/save";
		deleteUrl = homePath + "/admin/product/customer/delete";
		...
		$(function(){
			$("#product_customer_index").css("background-color","#ffffff");
			$("#content4").show();
		});
	</script>
</body>
