...
<body>
	...
	<div id="edit_box" style="display:none;">
		<form action="" class="e-form" method="post">
			<ul class="e-table" border="0">
				...
				<li>
					<p>标题:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="title" param-index="2" />
				</li>
				<li>
					<p>视频路径:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="videoUrl" param-index="3" />
				</li>
				
				<li>
					<p>描述:&nbsp;</p>
					<input type="text" class="form-control input-sm" name="description" param-index="4" />
				</li>
	...
	<script type="text/javascript">
		homePath = "${ctx}";
		findUrl = homePath + "/admin/product/video/find";
		saveUrl = homePath + "/admin/product/video/save";
		deleteUrl = homePath + "/admin/product/video/delete";
		...
		$(function(){
			$("#video_index").css("background-color","#ffffff");
			$("#content4").show();
		});
	</script>
</body>
