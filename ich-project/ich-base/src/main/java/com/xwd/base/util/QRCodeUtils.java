...
public class QRCodeUtils {
	...
	public static BufferedImage createImage(String content, String imgPath, boolean needCompress, int qrcodeSize)
		...
		// 插入图片
		QRCodeUtils.insertImage(image, imgPath, needCompress, qrcodeSize);
		return image;
	}
	 ...
	 * @throws Exception
	 */
	private static void insertImage(BufferedImage source, String imgPath, boolean needCompress, int qrcodeSize)	throws Exception {
	...
	public static void encode(String content, String imgPath, String destPath, boolean needCompress, int qrcodeSize)
			throws Exception {
		BufferedImage image = QRCodeUtils.createImage(content, imgPath, needCompress, qrcodeSize);
		File f = new File(destPath);
		if(!f.exists()){
			f.mkdirs();
		}
	...
	public static void encode(String content, OutputStream output, int qrcodeSize) throws Exception {
		QRCodeUtils.encode(content, null, output, false, qrcodeSize);
	}
	...
	public static void main(String[] args) throws Exception {
		String text = "{\"partId\": \"http://www.jd.com\"}";
		text="http://www.jd.com";
		QRCodeUtils.encode(text, "d:/logo_180x180.png", "d:/logo2.png",	false, 600);
		
		//String str = QRCodeUtils.decode("d:/logo3.png");
