...
@Controller
@Scope("prototype")
@RequestMapping("/action/customer/customerProduct")
public class CustomerProductAction extends BaseAdminController {
	...
	public String index() {
		return "/admin/base/customerProduct";
	}
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page page = customerProductService.findByPageRequest(pageRequest);
