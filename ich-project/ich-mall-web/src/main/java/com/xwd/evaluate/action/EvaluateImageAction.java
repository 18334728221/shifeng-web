...
@Controller
@Scope("prototype")
@RequestMapping("/action/evaluate/evaluateImage")
public class EvaluateImageAction extends BaseAdminController {
	...
	public String index() {
		return "/admin/base/evaluateImage";
	}
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page page = evaluateImageService.findByPageRequest(pageRequest);
