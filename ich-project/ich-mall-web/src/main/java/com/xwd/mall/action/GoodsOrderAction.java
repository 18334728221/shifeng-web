...
@Controller
@Scope("prototype")
@RequestMapping("/action/mall/goodsOrder")
public class GoodsOrderAction extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page page = goodsOrderService.findByPageRequest(pageRequest);
