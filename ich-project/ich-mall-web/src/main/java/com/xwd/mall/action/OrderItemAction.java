...
@Controller
@Scope("prototype")
@RequestMapping("/action/mall/orderItem")
public class OrderItemAction extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page page = orderItemService.findByPageRequest(pageRequest);
