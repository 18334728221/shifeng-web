...
@Controller
@Scope("prototype")
@RequestMapping("/action/customer/address")
public class AddressAction extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page page = addressService.findByPageRequest(pageRequest);
