package com.xwd.mall.customer.action;
...
@Controller
@Scope("prototype")
@RequestMapping("/action/customer/collection")
public class CustomerCollectionAction extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page page = collectionService.findByPageRequest(pageRequest);
	...
	public void save(HttpServletRequest request, HttpServletResponse response) throws Exception {
		CustomerCollection entity = new CustomerCollection();
