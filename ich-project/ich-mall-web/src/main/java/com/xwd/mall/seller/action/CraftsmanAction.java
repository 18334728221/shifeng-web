...
@Controller
@Scope("prototype")
@RequestMapping("/action/seller/craftsman")
public class CraftsmanAction extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page page = craftsmanService.findByPageRequest(pageRequest);
