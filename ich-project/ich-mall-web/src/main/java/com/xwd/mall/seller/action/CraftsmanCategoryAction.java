package com.xwd.mall.seller.action;
...
@Controller
@Scope("prototype")
@RequestMapping("/action/seller/craftsmanCategory")
public class CraftsmanCategoryAction extends BaseAdminController {
	...
	public String index() {
		return "/admin/base/craftsmanCategory";
	}
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page page = craftsmanCategoryService.findByPageRequest(pageRequest);
