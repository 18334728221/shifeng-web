...
@Controller
@Scope("prototype")
@RequestMapping("/action/base/categoryProperty")
public class CategoryPropertyAction extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page page = categoryPropertyService.findByPageRequest(pageRequest);
