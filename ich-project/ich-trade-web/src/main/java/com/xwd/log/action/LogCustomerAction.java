...
@Controller
@Scope("prototype")
@RequestMapping("/action/log/logCustomer")
public class LogCustomerAction extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page page = logCustomerService.findByPageRequest(pageRequest);
