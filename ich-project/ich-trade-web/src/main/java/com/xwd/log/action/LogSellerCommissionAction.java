...
@Controller
@Scope("prototype")
@RequestMapping("/action/log/logSellerCommission")
public class LogSellerCommissionAction extends BaseAdminController {
	...
	public String index() {
		return "/admin/base/logSellerCommission";
	}
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page page = logSellerCommissionService.findByPageRequest(pageRequest);
