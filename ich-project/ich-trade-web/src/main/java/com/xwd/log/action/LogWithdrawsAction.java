...
@Controller
@Scope("prototype")
@RequestMapping("/action/log/logWithdraws")
public class LogWithdrawsAction extends BaseAdminController {
	...
	public String index() {
		return "/admin/base/logWithdraws";
	}
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page page = logWithdrawsService.findByPageRequest(pageRequest);
