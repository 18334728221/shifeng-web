...
@Controller
@Scope("prototype")
@RequestMapping("/action/msg/smsCustomer")
public class SmsCustomerAction extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page page = smsCustomerService.findByPageRequest(pageRequest);
