...
@Controller
@Scope("prototype")
@RequestMapping("/public/market/quarterLine")
public class QuarterLinePublic extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page page = quarterLineService.findByPageRequest(pageRequest);
