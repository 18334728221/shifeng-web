...
@Controller
@Scope("prototype")
@RequestMapping("/action/market/tradeOrder")
public class TradeOrderAction extends BaseAdminController {
	...
	public void find(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Page page = tradeOrderService.findByPageRequest(pageRequest);
	...
	public 	void save(HttpServletRequest request, HttpServletResponse response)throws Exception {
		...
		tradeOrderService.saveOrUpdate(entity);
	...
	public 	void delete(HttpServletRequest request, HttpServletResponse response)throws Exception {
		String ids = get("ids");
		tradeOrderService.deleteByIds(ids);
		logService.add(request, "");
	}
